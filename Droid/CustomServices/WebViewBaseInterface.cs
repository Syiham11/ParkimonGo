...
//            {
//                ISharedPreferences prefs = PreferenceManager.GetDefaultSharedPreferences(_context);
//                loResultStr = prefs.GetString(Helper.BuildGlobalPreferenceKeyName(iWebView, iParameterName), string.Empty);
//            }
//            catch (Exception ex)
//            {
...
//                editor.PutString(Helper.BuildGlobalPreferenceKeyName(iWebView, iParameterName), iParameterValue);
...
//            try
//            {
//                //DroidContext.mainActivity.ChangeToTargetWebViewByTagName(iJSONWebViewParameters);
//            }
//            catch (Exception ex)
//            {
//                LoggingManager.LogApplicationError(ex, "WebViewMapFragment", "NavigateToPayByPlateListWebView");
